...
| Nexolu Payments Core | Cobros de suscripción (Wompi), compartido por todos los productos | (no clonado localmente todavía) | Ya integrado con el POS (checkout de suscripción) |
